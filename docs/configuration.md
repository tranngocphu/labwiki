...
See [the Code documentation]({% link docs/authoring/ui-components/code/index.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Callouts]({% link docs/authoring/ui-components/callouts.md %}) for more information.
