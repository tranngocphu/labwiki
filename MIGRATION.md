...
- Links wrap. PR: [#905]
- Callouts: a new component similar to alerts or banners. See [UI Components - Callouts]({% link docs/authoring/ui-components/callouts.md %}). PR: [#466]
